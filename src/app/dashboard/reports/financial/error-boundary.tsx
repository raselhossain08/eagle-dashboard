...
> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    console.error('Financial Error Boundary caught an error:', error, errorInfo);
  }
            ...
            <CardContent className="space-y-4">
              <div className="p-4 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800">
                <h4 className="font-medium text-red-800 dark:text-red-300 mb-2">
                  Financial Analytics Failed
                </h4>
                <p className="text-sm text-red-600 dark:text-red-400 mb-3">
                  {this.state.error?.message || 'An unexpected error occurred while loading the financial analytics dashboard.'}
                </p>
              ...
              <div className="text-sm text-muted-foreground">
                ...
                <ul className="list-disc list-inside mt-1 space-y-1">
                  ...
                  <li>Financial service unavailability</li>
