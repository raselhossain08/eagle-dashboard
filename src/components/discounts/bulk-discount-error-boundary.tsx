// components/discounts/bulk-discount-error-boundary.tsx
'use client';
...
export class BulkDiscountErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, errorInfo: any) {
    console.error('Bulk Discount Error Boundary caught an error:', error, errorInfo);
    ...
    if (typeof window !== 'undefined' && (window as any).gtag) {
      (window as any).gtag('event', 'exception', {
        description: `Bulk Discount Error: ${error.message}`,
        fatal: false,
      });
    }
  }
        ...
        >
          <Card className="max-w-3xl mx-auto">
            <CardHeader>
              ...
              <CardDescription>
                Something went wrong while processing bulk discount generation. Please try again.
              </CardDescription>
            </CardHeader>
...
export function BulkDiscountErrorWrapper({ children }: { children: ReactNode }) {
  return (
